...
const slides: Slide[] = [
  ...
  },
  {
    id: 5,
    name: "Zenith Home",
    subdivision: "Highpoint Residences",
        ...
        {openModal && (
          ...
          >
            <motion.div
              ...
              className="bg-white w-full max-w-5xl rounded-2xl p-8 relative"
            >
              <button
