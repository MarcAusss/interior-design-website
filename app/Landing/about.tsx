      ...
      {/* TITLE */}
        ...
        <div className="flex flex-col md:flex-row justify-between gap-10 md:gap-20">
            ...
            <p className="mb-4 text-base md:text-lg leading-relaxed">
                Founded with a vision to create spaces that tell stories, Forma Studio brings together a multidisciplinary team of designers, architects, and creatives. Each project is a journey of collaboration — listening, researching, and imagining alongside our clients.
            </p>
            <p className="text-base md:text-lg leading-relaxed">
                We design with intention. Whether it&apos;s a modern home, a heritage restoration, or a commercial interior, every detail is considered, every space is personal.
            </p>
            ...
            {/* RIGHT IMAGE */}
            <div className="w-full md:w-1/4 h-60 md:h-96 relative">
