...
// Desktop Project with scroll animation
function ProjectDesktop({ titleTop, titleBottom, images }: ProjectProps) {
  ...
  return (
    ...
    >
      ...
      <div className="w-full">
        {/* TITLE ROW */}
        <motion.div layout="position" className="flex gap-5 items-end">
          {/* TEXT LEFT */}
          <motion.p
            layout="position"
...
// Mobile Project: fully expanded, no animation
function ProjectMobile({ titleTop, titleBottom, images }: ProjectProps) {
  return (
    <div className="flex flex-col py-8 border-b border-gray-300">
      {/* TITLE ROW */}
      <div className="flex flex-col gap-3 mb-6">
        <p className="text-2xl font-light">{titleTop}</p>
        <p className="text-2xl font-light">{titleBottom}</p>
      </div>
...
export default function ProjectsPage() {
  const projects: ProjectProps[] = [
    ...
    },
    {
      ...
      images: [
        "/images/Exterior-Cam02-R1-1-0-0-1-scaled.jpg",
        "/images/image (4).png",
        "/images/image.png",
        "/images/image-5.png",
      ],
  ...
  return (
    <div className="bg-[#262324] py-10 text-white">
      <div className="mx-auto max-w-354 px-6 md:px-0">
        ...
        >
          <h1 className="text-4xl md:text-7xl">Selected Projects</h1>
          <p>[02]</p>
        </motion.div>
        ...
        >
          <Link className="bg-white px-7 py-3 rounded-full text-black" href="">
            View all Works
          </Link>
        </motion.div>
      </div>
